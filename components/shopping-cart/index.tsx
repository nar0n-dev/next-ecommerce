    ...
    <section className="cart">
      <div className="container">
        <div className="cart__intro">
          <h3 className="cart__title">Carrinho</h3>
        ...
        <div className="cart-actions">
          ...
          <input type="text" placeholder="Cupom" className="cart__promo-code" />

          <div className="cart-actions__items-wrapper">
            <p className="cart-actions__total">Total<strong>R${priceTotal().toFixed(2)}</strong></p>
