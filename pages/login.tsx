      ...
      <section className="form-page">
        <div className="container">
          <div className="back-button-section">
            <Link href="/products">
              <a><i className="icon-left"></i> Voltar para Loja</a>
            </Link>
          </div>

          <div className="form-block">
            <h2 className="form-block__title">Acessar</h2>
            <p className="form-block__description">Lorem Ipsum</p>
            ...
            <form className="form" onSubmit={handleSubmit(onSubmit)}>
              ...
              <p className="form__signup-link">Não tem cadastro? <a href="/register">Cadastre-se</a></p>
            </form>
          </div>
